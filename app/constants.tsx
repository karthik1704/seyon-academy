...
export const SERVER_IMAGE_URL = 'https://api.seyonacademy.com';
export const CDN_IMAGE_URL = 'https://cdn.seyonacademy.com';
...
export const LOGO_URL = '/images/logo/logo_new.png';
export const DASHBOARD_LOGO_URL = '/images/logo/logo_new.png';
