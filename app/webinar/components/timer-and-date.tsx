...
const Timer = () => {
  ...
  return (
    <div className=" bg-gradient-to-r from-red-500 to-purple-500 bg-clip-text text-transparent text-center p-8" >
      ...
      <p className="border border-red-500 bg-red-500 text-white rounded-full px-4 py-2 mt-4">
...
const TimerAndDate = () => {
  return (
    <div className="mx-auto w-full mt-24 gap-6">
      ...
      <div className="">
        <div className="border rounded-md border-[#58FF29] text-center p-8 mt-4 shadow-[0px_2px_47.3px_0px_#58FF292B] flex flex-col md:py-8  md:items-center md:justify-evenly md:w-full">
