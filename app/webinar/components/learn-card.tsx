...
const LearnCard = ({ title, description, image }: LearnCardProps) => {
  return (
    <div className="flex flex-col justify-center items-center gap-2 border rounded-lg m-2 w-[250px] md:w-[350px] h-[700px] transition-transform duration-300 hover:scale-105 hover:z-10">
      <div className="h-80 w-[80%] md:h-[400px] relative p-2 mt-4">
        <Image
          src={image}
