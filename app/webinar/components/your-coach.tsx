...
const YourCoach = () => {
  return (
    <div className="mx-auto w-full text-center mt-10">
      <h2 className="text-4xl font-extrabold text-center md:text-5xl capitalize mb-4">
        Your{" "}
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#cdff64] via-[#66d6ad] to-[#13b5e8]">
          Coach
        </span>
      </h2>
      <div className="flex border md:p-20 flex-col md:flex-row justify-center items-center text-center m-4 rounded-3xl">
        <div className="w-1/2">
          <Image
        ...
        <div className="md:w-1/2 p-4 flex flex-col justify-center md:items-center ">
          <h3 className="text-4xl md:text-2xl font-semibold text-center text-ellipsis mb-4">
            Rethina Balan
          </h3>
